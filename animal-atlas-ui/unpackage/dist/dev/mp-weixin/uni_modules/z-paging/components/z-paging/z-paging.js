...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    x: common_vendor.o$1((...args) => _ctx._onScrollToUpper && _ctx._onScrollToUpper(...args)),
    ...
    D: common_vendor.f(_ctx.virtualList, (item, index, i0) => {
      return common_vendor.e(_ctx.useCompatibilityMode ? {} : {
        ...
        e: common_vendor.o$1(($event) => _ctx._innerCellClick(item, _ctx.virtualTopRangeIndex + index), item["zp_unique_index"])
      });
    }),
    ...
    G: common_vendor.f(_ctx.realTotalData, (item, index, i0) => {
      return {
        ...
        c: index,
        d: common_vendor.o$1(($event) => _ctx._innerCellClick(item, index), index)
      };
    })
  }, {
    ...
    P: common_vendor.o$1(($event) => _ctx._onLoadingMore("click")),
    Q: common_vendor.p({
    ...
    Y: common_vendor.o$1(_ctx._emptyViewReload),
    Z: common_vendor.o$1(_ctx._emptyViewClick),
    aa: common_vendor.p({
    ...
    aM: common_vendor.o$1((...args) => _ctx._scroll && _ctx._scroll(...args)),
    aN: common_vendor.o$1((...args) => _ctx._onScrollToLower && _ctx._onScrollToLower(...args)),
    aO: common_vendor.o$1((...args) => _ctx._onScrollToUpper && _ctx._onScrollToUpper(...args)),
    aP: common_vendor.o$1((...args) => _ctx._onRestore && _ctx._onRestore(...args)),
    aQ: common_vendor.o$1(($event) => _ctx._onRefresh(true)),
    ...
    bf: common_vendor.o$1((...args) => _ctx._backToTopClick && _ctx._backToTopClick(...args))
  }) : {}, {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(uni_modules_zPaging_components_zPaging_js_zPagingMain._sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-1aa372d7"], ["__file", "D:/workspace/Project/animal-atlas/animal-atlas-ui/uni_modules/z-paging/components/z-paging/z-paging.vue"]]);
