...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    f: common_vendor.o$1($options.uploadFiles),
    g: common_vendor.o$1($options.choose),
    h: common_vendor.o$1($options.delFile),
    i: common_vendor.p({
    ...
    k: common_vendor.o$1($options.uploadFiles),
    l: common_vendor.o$1($options.choose),
    m: common_vendor.o$1($options.delFile),
    n: common_vendor.p({
      readonly: $props.readonly,
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/workspace/Project/animal-atlas/animal-atlas-ui/uni_modules/uni-file-picker/components/uni-file-picker/uni-file-picker.vue"]]);
