...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    b: common_vendor.o$1((...args) => $options.choose && $options.choose(...args))
  } : {}, {
    ...
    d: common_vendor.f($options.list, (item, index, i0) => {
      return common_vendor.e({
        ...
        b: common_vendor.o$1(($event) => $options.delFile(index), index)
      } : {}, {
        ...
        g: common_vendor.o$1(($event) => $options.uploadFiles(item, index), index)
      } : {}, {
        h: index,
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/workspace/Project/animal-atlas/animal-atlas-ui/uni_modules/uni-file-picker/components/uni-file-picker/upload-file.vue"]]);
