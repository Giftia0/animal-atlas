...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: common_vendor.f($props.filesList, (item, index, i0) => {
      return common_vendor.e({
        a: item.url,
        b: common_vendor.o$1(($event) => $options.prviewImage(item, index), index)
      }, $props.delIcon && !$props.readonly ? {
        c: common_vendor.o$1(($event) => $options.delFile(index), index)
      } : {}, {
        ...
        h: common_vendor.o$1(($event) => $options.uploadFiles(item, index), index)
      } : {}, {
        i: index
      });
    }),
    ...
    g: common_vendor.o$1((...args) => $options.choose && $options.choose(...args)),
    h: common_vendor.s($options.boxStyle)
  } : {});
}
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/workspace/Project/animal-atlas/animal-atlas-ui/uni_modules/uni-file-picker/components/uni-file-picker/upload-image.vue"]]);
