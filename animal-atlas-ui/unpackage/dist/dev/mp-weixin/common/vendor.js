...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__1D70903",
    appName: "animal-atlas-ui",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  {
    ...
    style: {
      navigationBarTitleText: "NCHU\u52A8\u7269\u56FE\u9274",
  ...
  {
    path: "pages/AnimalDetail/AnimalDetail",
    style: {
  ...
  {
    path: "pages/ForumPage/ForumPage",
    style: {
  ...
  {
    path: "pages/UpdateAnimal/UpdateAnimal",
    style: {
      navigationBarTitleText: "",
      enablePullDownRefresh: false
    }
  ...
  {
    path: "pages/AnimalIdentification/AnimalIdentification",
    style: {
  ...
  list: [
    {
      ...
      iconPath: "static/icon/tabbar/atlas/atlas.png",
      selectedIconPath: "static/icon/tabbar/atlas/atlas-selected.png"
    },
    {
      text: "\u8BC6\u522B",
      pagePath: "pages/AnimalIdentification/AnimalIdentification",
      iconPath: "static/icon/tabbar/identification/identification.png",
      selectedIconPath: "static/icon/tabbar/identification/identification-selected.png"
    },
    {
      text: "\u53D1\u73B0",
      pagePath: "pages/ForumPage/ForumPage",
      iconPath: "static/icon/tabbar/forum/forum.png",
      selectedIconPath: "static/icon/tabbar/forum/forum-selected.png"
    },
    {
      text: "\u6211\u7684",
...
class et extends Ge {
  async signIn(e2, t2) {
    ...
    const { refreshTokenKey: n2 } = this._cache.keys, s2 = await this._request.send("auth.signIn", { loginType: Me.USERNAME, username: e2, password: <REDACTED_PASSWORD> refresh_token: this._cache.getStore(n2) || "" }), { refresh_token: r2, access_token_expire: i2, access_token: o2 } = s2;
    if (r2)
