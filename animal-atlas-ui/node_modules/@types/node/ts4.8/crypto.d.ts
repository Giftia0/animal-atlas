...
declare module 'crypto' {
     ...
     * @param options `stream.transform` options
     */
    function createCipher(algorithm: CipherCCMTypes, password: <REDACTED_PASSWORD> options: CipherCCMOptions): CipherCCM;
    /** @deprecated since v10.0.0 use `createCipheriv()` */
    function createCipher(algorithm: CipherGCMTypes, password: <REDACTED_PASSWORD> options?: CipherGCMOptions): CipherGCM;
    /** @deprecated since v10.0.0 use `createCipheriv()` */
    function createCipher(algorithm: string, password: <REDACTED_PASSWORD> options?: stream.TransformOptions): Cipher;
    /**
     ...
     * @param options `stream.transform` options
     */
    function createDecipher(algorithm: CipherCCMTypes, password: <REDACTED_PASSWORD> options: CipherCCMOptions): DecipherCCM;
    /** @deprecated since v10.0.0 use `createDecipheriv()` */
    function createDecipher(algorithm: CipherGCMTypes, password: <REDACTED_PASSWORD> options?: CipherGCMOptions): DecipherGCM;
    /** @deprecated since v10.0.0 use `createDecipheriv()` */
    function createDecipher(algorithm: string, password: <REDACTED_PASSWORD> options?: stream.TransformOptions): Decipher;
    /**
     ...
     * @since v0.5.5
     */
    function pbkdf2(password: <REDACTED_PASSWORD> salt: BinaryLike, iterations: number, keylen: number, digest: string, callback: (err: Error | null, derivedKey: Buffer) => void): void;
    /**
     ...
     * @since v0.9.3
     */
    function pbkdf2Sync(password: <REDACTED_PASSWORD> salt: BinaryLike, iterations: number, keylen: number, digest: string): Buffer;
    /**
     ...
     * @since v10.5.0
     */
    function scrypt(password: <REDACTED_PASSWORD> salt: BinaryLike, keylen: number, callback: (err: Error | null, derivedKey: Buffer) => void): void;
    function scrypt(password: <REDACTED_PASSWORD> salt: BinaryLike, keylen: number, options: ScryptOptions, callback: (err: Error | null, derivedKey: Buffer) => void): void;
    /**
     ...
     * @since v10.5.0
     */
    function scryptSync(password: <REDACTED_PASSWORD> salt: BinaryLike, keylen: number, options?: ScryptOptions): Buffer;
